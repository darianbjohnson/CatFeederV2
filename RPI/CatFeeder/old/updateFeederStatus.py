...
time_delay_in_secs = 10 #30 #3600 # seconds between updating thingshadow - 1 hour
...
def update_shadows(sc):
	foodbowl_amount = 1 #update_foodbowl()
	print(self.update_foodbowl('x'))
	#hopper_amount = update_hopper
	
	JSONPayload = '{"state":{"desired":{"foodbowl":' +  str(update_foodbowl) + '}}}'
